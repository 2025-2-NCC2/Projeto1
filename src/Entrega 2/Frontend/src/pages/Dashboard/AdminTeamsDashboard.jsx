...
export default function AdminTeamsDashboard() {
  ...
  const columnsDonation = ['Nome do Grupo', 'Participante', 'Tipo', 'Data', 'Quantidade', 'Anexo', 'Validação Extrato'];
  const columns = ['Nome do Grupo', 'Mentor', 'Entrada', 'Status', 'Total (kg)', 'Total (R$)', 'Ação'];
    ...
    <div className="dashboard-container d-flex">
      ...
      <div className="sidebar shadow-sm border-end p-3">
        ...
        <nav className="sidebar-nav d-flex flex-column gap-2">
          ...
          <button className={`nav-link ${activeSection === "equipes" ? "active" : ""}`} onClick={() => setActiveSection("equipes")}>
        ...
        {activeSection === "visaoGeral" && (
          <>
            ...
            <div className="row g-3 mb-4">
              {[
                { label: "Equipes", valor: total?.total_groups, icon: "bi-diagram-3" },
                { label: "Membros", valor: total?.total_members, icon: "bi-people" },
                { label: "Total de KG's doados", valor: total?.total_food?.toFixed(2), icon: "bi-kanban" },
                { label: "Total de R$ arrecadado", valor: total?.total_money?.toFixed(2), icon: "bi-currency-dollar" }
              ].map((kpi, i) => (
          ...
          <>
            <div className="section-header d-flex justify-content-between align-items-center mb-4">
              ...
              <div className="d-flex gap">
                <select className="form-select mb-3" style={{ width: '15em' }} onChange={handleSelectGroup}>
              ...
              (<div>
                <div className="mt-4 tab-pane fade show active" id="tab-participantes" role="tabpanel" aria-labelledby="tab-participantes-tab">
                  <div className="card shadow-sm">
                    <div className="card-body">
                      <div className="d-flex mt-3 mb-4 fw-bold align-items-center justify-content-between flex-wrap gap-2 ">
                        <h5 className="fw-bold mb-0">Doações do grupo <span style={{ color: "#1eb31e" }}></span></h5>
                      </div>
        ...
        {activeSection === "doacoes" && (
          <>
            <div className="d-flex justify-content-between mb-3">
              ...
              <Button variant="primary" onClick={() => setShowDoacaoModal(true)}>Nova Doação</Button>
            </div>
          </>
        )}
