...
export default function Login() {
      ...
      switch (data.user.type) {
        ...
        case "Colaborador":
          ...
          localStorage.setItem(
            ...
            data.user.currentFoodCollection
          );
          localStorage.setItem(
            "currentMoneyCollection",
            data.user.currentMoneyCollection
          );
  ...
  return (
    <div
      className="d-flex justify-content-center align-items-center min-vh-100 py-3 py-md-0"
      style={{
        background:
    ...
    >
      <div
        className="d-flex flex-column flex-md-row shadow-lg rounded-4 overflow-hidden w-100"
        style={{
          maxWidth: "950px",
          backgroundColor: "#fff",
        }}
      >
        ...
        >
          <h2
            ...
            style={{ color: "#5b5b5b", fontSize: "clamp(1.5rem, 5vw, 2rem)" }}
          >
            Bem-vindo ao Áuria
          </h2>
          ...
          <form onSubmit={handleLogin} className="d-flex flex-column gap-4">
            ...
            <button
              type="submit"
              className="btn fw-semibold text-white py-2 py-md-3 rounded-3"
              style={{
        ...
        {/* Box da direita — verde clean e moderna (escondida em mobile) */}
        <div
        ...
        >
          ...
          >
            ...
            >
              Viva uma experiência que conecta corpo, mente e energia. Com o
              Áuria, você trilha o caminho do bem-estar de forma inteligente e
              inspiradora.
            </p>
            <div
              style={{
